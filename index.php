...
<body>
    <header>
        <div class="logo">
            <img src="imagens/logo.png" alt="Logo Pet Family">
    ...
    <main>
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <a href="#" class="hero-button" onclick="redirectToCadastro()">
                        <img src="imagens/botaov4.png" alt="Divulgue o Pet">
                    </a>
                    <a href="#" class="hero-button">
                        <img src="imagens/botaov5.png" alt="Adote um Pet">
                    </a>
                </div>
            </div>
            <div class="hero-image">
                <img src="imagens/img2.png" alt="Gato e Cães">
            </div>
            <div class="wave"></div>
        </section>
        ...
        <section class="adoption-section">
            ...
            <div class="adoption-cards">
                <a href="#" class="adoption-card">
                    <img src="imagens/gato1.png" alt="Marley">
                ...
                <a href="#" class="adoption-card">
                    <img src="imagens/gato2.png" alt="Pingo">
                    <div class="card-content">
                        <h3>Milo</h3>
                ...
                <a href="#" class="adoption-card">
                    <img src="imagens/cachorro1.png" alt="Djerry">
                    <div class="card-content">
                        <h3>Cleitinho</h3>
                ...
                <a href="#" class="adoption-card">
                    <img src="imagens/cachorro2.png" alt="Sem Nome">
                    <div class="card-content">
    ...
    <script>
        function redirectToCadastro() {
            <?php if ($isLoggedIn): ?>
                window.location.href = 'cadastro_doacaopet.html';
            <?php else: ?>
