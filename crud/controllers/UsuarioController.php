...
class UsuarioController
{
    ...
    public function update($id, $data)
    {
        try {
            ...
            return [
                'type' => 'error',
                'text' => 'Falha ao atualizar o usuário: ' . $e->getMessage()
            ];
        }
    }
    ...
    public function updateEndereco($usuario_id, $data)
    {
        try {
            ...
            return [
                'type' => 'success',
                'text' => 'Endereço do usuário atualizado com sucesso.'
            ];
        } catch (Exception $e) {
            ...
            return [
                'type' => 'error',
                'text' => 'Falha ao atualizar o endereço do usuário: ' . $e->getMessage()
            ];
        }
    }
    ...
    public function read($id)
    {
        try {
            ...
            throw new Exception("Falha ao buscar o usuário: " . $e->getMessage());
        }
    }
}
?>