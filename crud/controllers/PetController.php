...
class PetController {
    ...
    public function cadastrarDoacao($especie_id, $raca, $cor, $idade, $descricao, $fotos, $usuario_id){
        $pet_id = $this->petModel->insertPet( $especie_id, $raca, $cor, $idade,  $descricao);
        if (!$pet_id) {
    ...
    public function editarDoacao($doacao_id, $especie_id, $raca, $cor, $idade, $descricao, $fotos){
        ...
        if (!$this->petModel->editarPet($pet_id, $especie_id, $raca, $cor, $idade, $descricao)) {
